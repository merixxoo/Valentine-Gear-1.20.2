...
public enum ModArmorMaterials implements ArmorMaterial {
    VALENTINE("valentine",65,new int[]{7,11,9,6},25,
            SoundEvents.BLOCK_AMETHYST_BLOCK_CHIME, 3.5f,0.3f,()-> Ingredient.ofItems(ModItems.VALENTINE_INGOT));
    ...
    public String getName() {
        return ValentineGear.MOD_ID + ":"+this.name;
    }
